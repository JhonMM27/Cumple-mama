...
export const messages = [
  ...
  },
  {
    name: "Naty",
    message:
      `Mami, en este día tan especial, desearte la mayor felicidad del mundo, que dios nos siga brindando más años juntos de celebración entre tú y todos tus hijos, eres la persona más importante en mi vida y quiero siempre lo mejor para ti, feliz cumpleaños mami, un abrazo enorme 🥰`.trim(),
    image:
      "img/Naty.jpg",
  },
  {
